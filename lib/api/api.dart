...
class APIs {
  ...
  static Future<void> updateProfilePicture(File file) async {
    ...
    log('Extension: $ext');
    storage.ref().child('profile_pictures/${user.uid}.$ext');
      ...
      var res = await post(Uri.parse('https://fcm.googleapis.com/fcm/send'),
          headers: {
            ...
            HttpHeaders.authorizationHeader:
                'key=AAAAFrKaaFE:APA91bG-YUREgnGlZhAMeaQ8CIFOIW_JH8JEoG9ed44dPSSn6sib_9KfFoFRQRtacBeWPZ6wQUfjLcQ1zWTg-1fiUb00bWWHr1ZZAF0insQoxcgxQdS1DKWmPEalF7n8eUUXonXf6tpo'
          },
